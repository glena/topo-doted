module.exports = function (config) {
	...
	fs.writeFile(config.outputDirectory + "/topo-doted-projection.js", fileData, function(err) {
        if(err) {
            return console.log(err);
        }

        console.log("The projection was saved! - "+config.outputDirectory+"/topo-doted-projection.js");
    });
